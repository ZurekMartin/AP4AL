...
// Pridany kod na zaklade zadani BubbleSort - metod pro serazeni listu pomoci BubbleSort
void List_BubbleSort(List_t *const list);
/*! Seradi list pomoci BubbleSort metody.
 *
 * \param[in] list  List, jehoz obsah chceme seradit.
 */
